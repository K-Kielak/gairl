...
HIDDEN_LAYERS = [24, 24]
OUTPUT_DIRECTORY = os.path.join(OUTPUTS_DIR, 'acrobot', 'pddqn',
                                '6464gdsc5e-3batch256')
DTYPE = tf.float64
...
REPLAY_BUFFER = PrioritizedReplayBuffer(2**20, 512, 256,
                                        beta_annealing_period=50000)
UPDATE_FREQ = 4
